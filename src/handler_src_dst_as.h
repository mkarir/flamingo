#ifndef __HANDLER_SRC_DEST_AS_H__
#define __HANDLER_SRC_DEST_AS_H__
...
gint handler_src_dst_as_compare_nodes(tree_node_t *node_a_in, tree_node_t *node_b_in);
tree_node_t *handler_src_dst_as_lookup_node_from_string(gchar *node_str);
void handler_src_dst_as_init_interface(void);
